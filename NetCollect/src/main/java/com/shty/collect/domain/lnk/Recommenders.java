...
public class Recommenders {
	...
	private Long recommendationreceived_id;
	...
	public Long getRecommendationreceived_id() {
		return recommendationreceived_id;
	}

	public void setRecommendationreceived_id(Long recommendationreceived_id) {
		this.recommendationreceived_id = recommendationreceived_id;
	}

	@Override
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("Recommenders [id=");
		builder.append(id);
		...
		builder.append(lnkid);
		builder.append(", recommendationreceived_id=");
		builder.append(recommendationreceived_id);
		builder.append("]");
